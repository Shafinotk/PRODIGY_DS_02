...
# ### AIM :
# 
#  To perform data cleaning and exploratory data analysis (EDA) on the insurance dataset. The dataset contains information about individuals, including their age, gender, body mass index (BMI), and other attributes.
# 
